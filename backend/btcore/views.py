...
class MatchView(views.APIView):
    queryset = models.Match.objects.prefetch_related('rosters__players__stats')
...
class PlayerView(views.APIView):
    queryset = models.Player.objects.prefetch_related('matches__stats',
                                                      'matches__roster__match')

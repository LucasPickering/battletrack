    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shard', models.CharField(choices=[('pc-as', 'PC-AS'), ('pc-eu', 'PC-EU'), ('pc-kakao', 'PC-KAKAO'), ('pc-krjp', 'PC-KRJP'), ('pc-jp', 'PC-JP'), ('pc-na', 'PC-NA'), ('pc-oc', 'PC-OC'), ('pc-ru', 'PC-RU'), ('pc-sa', 'PC-SA'), ('pc-sea', 'PC-SEA')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='RosterMatch',

# Generated by Django 2.0.4 on 2018-04-30 05:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', btcore.models.PositionField(max_length=64)),
            ],
            bases=('btcore.event',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('event_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='btcore.Event')),
                ('red_zone', btcore.models.CircleField(blank=True, max_length=24)),
                ('white_zone', btcore.models.CircleField(blank=True, max_length=24)),
                ('blue_zone', btcore.models.CircleField(max_length=24)),
            ],
            bases=('btcore.event',),
        ),
        migrations.CreateModel(
        ...
        migrations.AlterUniqueTogether(
            name='player',
            unique_together={('name', 'shard'), ('id', 'shard')},
        ),
        migrations.CreateModel(
